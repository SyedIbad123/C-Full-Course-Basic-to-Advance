...
int main()
{
    ...
    cout << "size of float : " << sizeof(n1) << endl;
    cout << "size of double : " << sizeof(n2) << endl;
    cout << "size of long double : " << sizeof(n3) << endl;

    // Precision
    cout << setprecision(20);              // Control the precision from cout.
    cout << "number1 is : " << n1 << endl; // 7 digits
    cout << "number2 is : " << n2 << endl; // 15'ish digitsc
    cout << "number3 is : " << n3 << endl; // 15+ digits
